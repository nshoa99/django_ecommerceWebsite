...
def register(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # messages.success(request, 'Thank you for registering with us! We have send you a verification mail to your email address, please verify!')
...
def resetPassword(request):
    if request.method == 'POST':
        ...
        if password == confirm_password:
            ...
            user.save()
            messages.success(
                request, 'Your password has been reset successful')
            return redirect('login')
        else:
    ...
    if request.method == 'POST':
        ...
        if new_password == confirm_password:
            ...
            if success:
                ...
                messages.error(
                    request, 'Your current is wrong, please type it agin!')
                return redirect('change_password')
        else:
            messages.error(
                request, 'Your new password and confirm password does not match')
            return redirect('change_password')
